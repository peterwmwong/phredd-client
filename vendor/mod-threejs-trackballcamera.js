...
THREE.TrackballCamera = function ( parameters ) {
  ...
  /*************************
   * PHREDD-MODIFIED START *
   *************************/
  this.wheelZoomSpeed = parameters.wheelZoomSpeed || .06;
  /*************************
   *  PHREDD-MODIFIED END  *
   *************************/
  ...
  this.wheelZoom = parameters.wheelZoom || false;
  ...
  _wheelZoom = 0,
	...
	this.wheelZoomCamera = function() {

		var factor = 1.0 + _wheelZoom * this.wheelZoomSpeed;
		if ( factor !== 1.0 && factor > 0.0 ) {
			...
			if ( this.staticMoving ) {
				...
				_wheelZoom -= _wheelZoom * this.dynamicDampingFactor;
   ...
   * PHREDD-MODIFIED START *
   *************************/
  function mousewheel(isZoomIn){
    _wheelZoom += ((isZoomIn) ? 1 : -1);
  };
  /*************************
   *  PHREDD-MODIFIED END  *
   *************************/
  ...
  if(jQuery.browser.mozilla){
    this.domElement.addEventListener(
      'DOMMouseScroll',
      bind( this, function(event){ mousewheel(event.detail < 0 ); } ),
      false
    );
  }else{ // Webkit
    this.domElement.onmousewheel =
 ...
 *************************/
// Left Mouse - PAN
// Disable the rest - Mouse wheel zoom is implemented above
THREE.TrackballCamera.prototype.STATE = { NONE : -1, ROTATE : 1, ZOOM : -2, PAN : 0 };
/*************************
 *  PHREDD-MODIFIED END  *
 *************************/
